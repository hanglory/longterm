...
function div_html_list(data){
	...
	for(let i=0; i<data.length; i++) {
        ...
        htmlStr += '  <div class="mvInlineN td_chk">'+data[i].FUEL_NM+'</div>';
...
<img class="logo-img" src="${RPATH}/images/logo2.png" alt="" align="middle">
