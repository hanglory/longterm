...
<li>
					...
					<div class="category-box">
						...
						<div class="content ca">
							...
							<div class="cmb-item">
								<span>수수료</span><span>(0.0 ~ 3.0%)</span>
								<input type="number" pattern="\d*" name="commission" id="commission" placeholder="" min="0.0" max="3.0" step="0.1"/>%
							</div>
				...
				<div id="btn-estimate">상세견적서 보기(PDF&저장)</div>
				<div class="btn-wrap">
...
window.addEventListener("load", function() {
	document.querySelector("header li:nth-child(2)").classList.add("selected");
});
</script>
