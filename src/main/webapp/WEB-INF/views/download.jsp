...
<br>
	...
	<a href="${RPATH}/images/hi_contract.hwp" download><button class = "downbtn" style = "background-color: #008CBA;">하이렌트 계약서 다운로드</button></a>
        	<a href="${RPATH}/images/mi_contract.hwp" download><button class = "downbtn" style = "background-color: #008CBA;" >마이다스 계약서 다운로드</button></a>
        
   
    
<br>

        <a href="${RPATH}/images/menu_guide.pdf" download><button class = "downbtn" style = "background-color: #4CAF50; " >홈페이지 메뉴얼 다운로드</button></a>
    
        <a href="${RPATH}/images/process.pdf" download><button class = "downbtn" style = "background-color: #4CAF50; " >계약진행 프로세스</button></a>

<br>

 <a href="${RPATH}/images/owner-rent.pdf" download><button class = "downbtn" style = "background-color: #008CBA; margin-bottom: 300px;" >오너형 상품설명서</button></a>
 <a href="${RPATH}/images/onwer_contract.hwp" download><button class = "downbtn" style = "background-color: #008CBA; " >오너형 계약서 다운로드</button></a>
</div> 
