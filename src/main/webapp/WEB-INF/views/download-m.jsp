...
<br>
    ...
    <a href="${RPATH}/images/process.pdf" download><button class = "downbtn" style = "background-color: #4CAF50; " >계약진행 프로세스 <br> 다운로드</button></a>

<br>

 <a href="${RPATH}/images/owner-rent.pdf" download><button class = "downbtn" style = "background-color: #008CBA; margin-bottom: 100px; " >오너형 상품설명서 <br> 다운로드</button></a>
 <a href="${RPATH}/images/onwer_contract.hwp" download><button class = "downbtn" style = "background-color: #008CBA; " >오너형 계약서 <br> 다운로드</button></a>
</div> 
