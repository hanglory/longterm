...
(function(factory) {
    ...
    var Buttons = function(context) {
        ...
        this.isFontInstalled = function(name) {
            if ( ! self.fontInstalledMap.hasOwnProperty(name) && ! name.startsWith("Thread")) {
                self.fontInstalledMap[name] = agent.isFontInstalled(name) ||
                    list.contains(options.fontNamesIgnoreCheck, name);
            }

            //009
            if(name == undefined || name == '' || name.startsWith("Thread")) {
            	name = 'Nanum Gothic';
            }
        ...
        this.updateCurrentStyle = function() {
            ...
            if (styleInfo['font-family']) {
                ...
                if(fontName == undefined || fontName == '' || fontName.startsWith("Thread")) {
    ...
    $.summernote = $.extend($.summernote, {
        ...
        options: {
            ...
            toolbar: [
                ...
                ['table', ['table']],
                ['insert', ['ajaxImage', 'paxvideo', 'openGraph']],
                ['view', ['codeview']]
                /*    	  
                        ['style', ['style']],
                        ['font', ['bold', 'underline', 'clear']],
